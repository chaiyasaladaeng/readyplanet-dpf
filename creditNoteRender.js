...
module.exports = function  creditNoteRender(documentPDF, docs, transactionArray, page) {
    ...
    documentPDF
        ...
        .fontSize(18)
        .font(fontBoldPath)
        .text('ใบลดหนี้/ใบกำกับภาษี', 435, 55, {align: 'left'})
    ...
    documentPDF
        .fontSize(14)
        .font(fontpath)
        .text('เลขที่ใบลดหนี้ :', headX, headY)
        .text(docs['ED.ID'], headX + 60, headY)
        .text('วันที่ :', headX + 35, headY + 20)
        .text(formatDate(docs['ED.IssueDateTime']), headX + 60, headY + 20)
    ...
    documentPDF
        ...
        //ที่อยู่ลูกค้า
        documentPDF.moveDown (0.2)
        .text(docs['SCTT.AHTA.BTP.PTA.LineOne'] +' '+ docs['SCTT.AHTA.BTP.PTA.LineTwo'] +' '+ docs['SCTT.AHTA.BTP.PTA.LineThree'] +' '+ docs['SCTT.AHTA.BTP.PTA.LineFour'],{width: 240})
    ...
    documentPDF.text('สาเหตุการคืนสินค้าและบริการ : ฟังก์ชั่นไม่ตอบโจทย์ ยกเลิกบริการ ทำเรื่องคืนเงิน', textX , startTotalBoxY - 20)
